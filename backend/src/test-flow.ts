...
//     const mockCategory = await CategoryService.createCategory({
//       name: categoryName,
//       description:
...
//     const liveCategory = categories.find((c: any) => c.name === categoryName);
//     if (!liveCategory)
...
//     const mockProduct = await ProductService.createProduct({
...
//     const liveProduct = products.find((p: any) => p.sku === productSku);
//     if (!liveProduct)
//       throw new Error(
